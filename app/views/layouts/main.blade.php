        ...
        @if(Auth::check())
                    <nav class="dropdown">
                        <ul>
                            <li>
                                <a href="#">
                            {{ HTML::image('img/user-icon.gif',Auth::user()->f_name)}}
                        {{Auth::user()->f_name}} {{ HTML::image('img/down-arrow.gif',Auth::user()->f_name)}}
                                 </a>
                                <ul>
...
<script>window.jQuery || document.write( "{{ HTML::script('js/vendor/jquery-1.9.1.min.js') }}")
        </script>
